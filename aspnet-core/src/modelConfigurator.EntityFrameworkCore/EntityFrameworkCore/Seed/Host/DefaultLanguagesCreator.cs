...
namespace modelConfigurator.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly modelConfiguratorDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = modelConfiguratorConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(modelConfiguratorDbContext context)
        {
            _context = context;
        }
