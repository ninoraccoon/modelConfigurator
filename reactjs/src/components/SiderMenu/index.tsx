...
import { //Avatar, 
  Col, Layout, Menu } from 'antd';
import { L, isGranted } from '../../lib/abpUtility';

//import AbpLogo from '../../images/document-print-preview.png';
    ...
    <Sider trigger={null} className={'sidebar'} width={256} collapsible collapsed={collapsed} onCollapse={onCollapse}>
      {collapsed ? (
        <Col style={{ textAlign: 'center', marginTop: 15, marginBottom: 10 }}>
          <span style={{color:'white'}}>Model Configurator Logo
          </span>
        ...
        <Col style={{ textAlign: 'center', marginTop: 15, marginBottom: 10 }}>
          ...
          {/* <Avatar shape="square" style={{ height: 25, width: 25 }} src={AbpLogo} /> */}
        </Col>
      )}
