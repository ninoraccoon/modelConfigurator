...
export class Dashboard extends React.Component<any> {
  ...
  render() {
    const { cardLoading 
      //,lineChartLoading
      //, barChartLoading, pieChartLoading 
    } = this.state;
        ...
        <Row gutter={16}>
          ...
          >
            <Card className={'dasboardCard-task'} bodyStyle={{ padding: 10 }} loading={cardLoading} bordered={false}>
              ...
              <Col span={16}>
                <p className={'dashboardCardName'}>Models Review</p>
                <label className={'dashboardCardCounter'}>0</label>
              </Col>
            </Card>
          </Col>
          <Col
          ...
          >
            <Card className={'dasboardCard-ticket'} bodyStyle={{ padding: 10 }} loading={cardLoading} bordered={false}>
              ...
              <Col span={16}>
                <p className={'dashboardCardName'}>Models Avail.</p>
                <label className={'dashboardCardCounter'}>0</label>
              </Col>
            </Card>
          </Col>
          ...
          >
            <Card className={'dasboardCard-comment'} bodyStyle={{ padding: 10 }} loading={cardLoading} bordered={false}>
              ...
              <Col span={16}>
                <p className={'dashboardCardName'}>Comments</p>
                <label className={'dashboardCardCounter'}>0</label>
              </Col>
            </Card>
          </Col>
          ...
          >
            <Card className={'dasboardCard-visitor'} bodyStyle={{ padding: 10 }} loading={cardLoading} bordered={false}>
              ...
              <Col span={16}>
                <p className={'dashboardCardName'}>Visitors</p>
                <label className={'dashboardCardCounter'}>0</label>
              </Col>
            </Card>
          </Col>
